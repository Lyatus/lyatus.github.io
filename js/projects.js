var projects = {
	'l-engine':{
		...
		'content':
			...
			+"<h2>Threading</h2><p>The engine uses a fiber-based task system, I was very much influenced by Christian Gyrling's <a href=\"http://www.gdcvault.com/play/1022186/Parallelizing-the-Naughty-Dog-Engine\">talk</a> about Naughty Dog's use for them in their job system. One difference with their job system is that mine does not move tasks from thread to thread (once a task starts on a thread, it ends there). Currently the physics and collision parts of the engine make use of the task system.</p>"
