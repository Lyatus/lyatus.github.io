const projects = {
	...
	steve: {
		...
		content:
			...
			+"<h2>Chord Progression</h2><p>Chord progression is a central part of tonal music. Steve uses information from the configuration to establish which chord changes are available.</p>"
